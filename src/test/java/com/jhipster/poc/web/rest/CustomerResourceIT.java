package com.jhipster.poc.web.rest;
...
import com.jhipster.poc.IntegrationTest;
import com.jhipster.poc.domain.Customer;
import com.jhipster.poc.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_ACCOUNTNUM = "AAAAAAAAAA";
    private static final String UPDATED_ACCOUNTNUM = "BBBBBBBBBB";
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAccountnum()).isEqualTo(DEFAULT_ACCOUNTNUM);
    }
    ...
    @Test
    @Transactional
    void checkAccountnumIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setAccountnum(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].accountnum").value(hasItem(DEFAULT_ACCOUNTNUM)));
    }
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.accountnum").value(DEFAULT_ACCOUNTNUM));
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAccountnum()).isEqualTo(UPDATED_ACCOUNTNUM);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.lastname(UPDATED_LASTNAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE).accountnum(UPDATED_ACCOUNTNUM);
